...
cl = LINETCR.LINE()
cl.login(token="EyyyjtJnTo0TVCyjVuf0.9q2iIcfJltjghJCvoSD1Wa.HRrL1K4c/d29sjzfvfUVHlUXiR2JkVVe2TqlS1I3/hI=")
cl.loginResult()

ki = LINETCR.LINE()
ki.login(token="EylwNRbny7a8D1vfRpA5.BAbZE0umy2dUOSbpoBpzPq.H3EMu7YL7w/a9FY/jGi1E/d9+Og9Zi/dERTfSieiM6g=")
ki.loginResult()

kk = LINETCR.LINE()
kk.login(token="EyXJNWF6y1zW1GnizWMc.YCFgbMZPhmkVN+eVj380ta.6nVqb3ASil8TAO9WszvrDJNqqdfzx0QfkLy6bc3eEWI=")
kk.loginResult()

kc = LINETCR.LINE()
kc.login(token="Eyb0fcWK5wZ1uvPytSUf.jcKRHQZO/ZUdXspu91JKJW.d3HXOtukuXhoxaHMc7m9IdgxcPa5yCQkEFnT5iITCsw=")
kc.loginResult()

kb = LINETCR.LINE()
kb.login(token="EyAQ79DLDkucvKyc1AG2.a3wwcrKoF7GSYZK8iLIneG.2iD3z3lgy1Cr3nJRkpAlZA5nacQaZL1qCSlIKynlNHQ=")
kb.loginResult()

kd = LINETCR.LINE()
kd.login(token="EyyXfpN3qjFPsUe37WIc.lRANtBt0XNe7AUiARUwHRa.l0qQqTHbJayYVLg8rQY9Deu3+g/ER2T9GePnH/H95gc=")
kd.loginResult()

ke = LINETCR.LINE()
ke.login(token="EyR76JfEemTkEKmtj6n2./LjutxDotUFL1qqbWYLg0G.ZA0fUTd91nuYrshzGosja2bMgfY6EqSN2Q0VHp/ywgc=")
ke.loginResult()

kg = LINETCR.LINE()
kg.login(token="EyrndlbyBSC2ZbvluIWb.d+8dm1wfnENnVH33/TFNkW.wq407H18HudH0uH25uGEiPySdU3OKAguz9T/3aHiJVw=")
kg.loginResult()

kh = LINETCR.LINE()
kh.login(token="EyCEnzie13A2iFZ9Ncg4.q5eKTus+y7F5Lcc39+6ADa.ljH1uqoxiCPwW3nbyokeiw64q06Ouc2fhjl5VWGilXg=")
kh.loginResult()

sw = LINETCR.LINE()
sw.login(token="EySNpwhs4ZLHmeNoE9a0.wa8B30bh0DW1uW057OP4ma.79i+ULHjuLI7o7ZLEPceWOLoa4PaLe160DatcONQXqM=")
sw.loginResult()
...
╠ 🦂❧❥Say 「Text」
╠ 🦂❧❥Sd in 「All bot join」
╠ 🦂❧Sd out 「All bot leave」
╠ 🦂❧Sd copy 「@」
╠ 🦂❧Sd kembali 「@」
╠ 🦂❧❥Sd kick 「Mid」
╠ 🦂❧❥Sd invite 「Mid」
╠ 🦂❧❥Sd setting 「View bot setting」
╠ 🦂❧❥Sd bot 「Cek all bots」
╠ 🦂❧❥Sd cancel ,..「Cancel all pending」
╠ 🦂❧❥Sd link 「on / off」
╠ 🦂❧❥Sd play 「Cleanse this group」
╠ 🦂❧❥Clearall 「Cleanse group」
╠ 🦂❧❥ Sd ban 「Blacklist all member」
╠ 🦂❧❥ Sd del 「Unblacklist all member」
...
Bots = [mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid,"uf50d888821632d32461e37153ac775c0"]
...
wait ={ 
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"Thanks for add Created by Sadis",
    "lang":"JP",
...
#-----------------------------------------------------------------
        ...
        if op.type == 25:
                     ...
                     if msg.from_ in admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 ...
                                 cl.sendText(msg.to,"Sorry 😉 " + _name + " Ada di daftar Blacklist Sadis bots")
                                 cl.sendText(msg.to,"Call my Sadis to use command !, \n➡Unban: " + invite)
                                 break
                             else:
                     ...
                     if msg.from_ in admin:
                         ...
                         for s in groups.members:
                             if _name in s.displayName:
                                 ...
                                 ki.sendText(msg.to,"Call my Sadis to use command !, \n➡ Unban: " + invite)
                                 break
                             else:
                                 targets.append(invite)
                         if targets == []:
	      ...
	      if msg.from_ in admin:
            ...
            elif "Sd kick " in msg.text:
	      if msg.from_ in admin:
                midd = msg.text.replace("Sd kick ","")
	      ...
	      if msg.from_ in admin:
            ...
            elif "Sd invite " in msg.text: 
	      if msg.from_ in admin:
                midd = msg.text.replace("Sd invite ","")
	      ...
	      if msg.from_ in admin:
            ...
            elif msg.text in ["Qr on","Sd link on"]:
	      if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = False
                ...
                if msg.toType == 2:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        kk.sendText(msg.to,"Not for use less than group")
            elif msg.text in ["Qr off","Sd link off"]:
	      if msg.from_ in admin:
                if msg.toType == 2:
                    X = cl.getGroup(msg.to)
                    X.preventJoinByTicket = True
...
#---------------------------------------------------------------------------------------------
		...
		if wait["Protectgroupname"] == False:
			...
			cl.sendText(msg.to,"Gnamelock already off")
#---------------------------------------------------------------------------------------------
	    elif msg.text in ["Allprotect on","Sw on","Sd on"]:
	      if msg.from_ in admin:
                ...
                if wait["cancelprotect"] == True:
                    ...
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"CancelProtect already On")
#-----------------------------------------------------------------------------------------
            elif msg.text in ["Allprotect off","Sw off","Sd off"]:
              if msg.from_ in admin:
...
#----------------------------------------------------------------------------------------------
	      ...
	      if msg.from_ in admin:
            ...
            elif msg.text in ["Sadis seting","Set","Set view","Setting"]:
	      if msg.from_ in admin:
...
#------------------------[Copy]-------------------------
	      ...
	      if msg.from_ in admin:
            ...
            elif "Sd:Bc " in msg.text:
                bctxt = msg.text.replace("Sd:Bc ", "")
...
#_______________
            elif "Invite aku: " in msg.text:
                if msg.from_ in owner:
                    gid = msg.text.replace("Inviteaku: ","")
                    if gid == "":
            ...
            elif msg.text in ["Sd leaveAllGc"]:
              if msg.from_ in admin:
                gid = cl.getGroupIdsJoined()
                gid = ki.getGroupIdsJoined()
                gid = kk.getGroupIdsJoined()
	      ...
	      if msg.from_ in admin:
            ...
            elif "Sd copy @" in msg.text:
	      if msg.from_ in admin:
                if msg.toType == 2:
                    print "[Copy]"
                    _name = msg.text.replace("Sd copy @","")
                    _nametarget = _name.rstrip(' ')
                    gs = cl.getGroup(msg.to)
                    targets = []
                    for g in gs.members:
	    ...
	    elif "Sd clone @" in msg.text:
	      if msg.from_ in admin: 
		if msg.toType == 2:
                    print "[Copy]"
		    _name = msg.text.replace("Sd clone @","")
                    _nametarget = _name.rstrip(' ') 
		    gs = kc.getGroup(msg.to)
                    targets = [] 
		    for g in gs.members:
...
#-----------------------------------------------
	      ...
	      if msg.from_ in admin:
            ...
            elif "Sd play" in msg.text:
	      if msg.from_ in admin:
                if msg.toType == 2:
                    print "ok"
                    _name = msg.text.replace("Sd play","")
                    gs = ki.getGroup(msg.to)
                    gs = kk.getGroup(msg.to)
		    gs = kc.getGroup(msg.to)
...
#-----------------------------------------------------------------------
	    ...
	    elif "Sd del" in msg.text:
	      if msg.from_ in admin:
                wait["blacklist"] = {}
                cl.sendText(msg.to,"Blacklist user succes dibersihkan")

            elif "Sd ban" in msg.text:
              if msg.toType == 2:
                  if msg.from_ in admin:                                        
                       ban0 = msg.text.replace("Sd ban","")
                       ban1 = ban0.lstrip()
                       ban2 = ban1.replace("@","")
                       ban3 = ban2.rstrip()
                       _name = ban3
